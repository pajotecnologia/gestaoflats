...
- **v2.29.21**: Sincronização dinâmica de mensalidades e planos SaaS na tabela de empresas clientes da Gestão SaaS e enriquecimento do modal Liberar / Plano com todos os planos intermediários.
- **v2.29.20**: Criação dos planos intermediários Smart (5 imóveis), Performance (15 imóveis) e Premium (20 imóveis), integrados à Landing Page, checkout, limites do backend e matriz de gestão SaaS.
