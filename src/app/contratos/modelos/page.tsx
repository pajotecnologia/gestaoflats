  ...
  const handleSwitchViewMode = (mode: "editor" | "code" | "preview") => {
    if (mode === "code" && activeViewMode === "editor" && editorRef.current) {
      ...
      const mockContrato = {
        ...
        bancoDadosConta: "Ag: 1234-5 / CC: 98765-4 / Chave PIX: 12.345.678/0001-90",
  ...
  const tagsCategorizadas = [
    {
      ...
      tags: [
        ...
        { label: "Estado Civil", tag: "{{locatario.estadoCivil}}" },
        { label: "Profissão", tag: "{{locatario.profissao}}" },
        { label: "Nacionalidade", tag: "{{locatario.nacionalidade}}" },
        { label: "Qualificação Completa", tag: "{{locatario.qualificacaoCompleta}}" },
    ...
    },
    {
      ...
      tags: [
        ...
        { label: "Dia do Vencimento", tag: "{{contrato.diaVencimento}}" },
        { label: "Forma de Pagamento", tag: "{{contrato.formaPagamento}}" },
        { label: "Nome do Banco", tag: "{{contrato.bancoNome}}" },
        { label: "Dados da Conta / PIX", tag: "{{contrato.bancoDadosConta}}" },
        { label: "Multa por Atraso (%)", tag: "{{contrato.multaAtrasoPercentual}}" },
        { label: "Juros por Atraso (%)", tag: "{{contrato.jurosAtrasoPercentual}}" },
        { label: "Valor da Caução (R$)", tag: "{{contrato.valorCaucao}}" },
        { label: "Caução (Equiv. Parcelas)", tag: "{{contrato.caucaoParcelas}}" },
        { label: "Multa Rescisória (Meses)", tag: "{{contrato.multaRescisaoMeses}}" },
    ...
    },
    {
      ...
      tags: [
        ...
        { label: "Logradouro / Rua", tag: "{{empresa.endereco}}" },
        { label: "Bairro da Empresa", tag: "{{empresa.bairro}}" },
        { label: "Cidade da Empresa", tag: "{{empresa.cidade}}" },
        { label: "Estado (UF) da Empresa", tag: "{{empresa.estado}}" },
        { label: "CEP da Empresa", tag: "{{empresa.cep}}" },
        { label: "Endereço Completo", tag: "{{empresa.enderecoCompleto}}" },
      ],
    },
  ];
