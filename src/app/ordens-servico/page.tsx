  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.contaPagarCriada) {
        toast.success("Ordem de serviço aberta e despesa lançada no Contas a Pagar com sucesso!");
      } else {
  ...
  return (
    <Shell>
      <div className="space-y-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-zinc-400">
                Abertura de chamados, controle de custos e integração direta com o Contas a Pagar
              </p>
            </div>
          </div>
                  ...
                  <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-950/80 border border-slate-200/80 dark:border-zinc-800/80 text-xs space-y-2">
                    ...
                    {ordem.responsavel && (
                      <div className="flex items-center space-x-1.5 text-slate-600 dark:text-zinc-400 text-[11px]">
                        ...
                        <span>Resp: {ordem.responsavel}</span>
                      </div>
                    )}
        ...
        {/* MODAL ORGANIZADO COM INTEGRAÇÃO FINANCEIRA COMPLETA */}
        {modalOpen && (
                ...
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Preencha os dados e os custos para controle e lançamento no Contas a Pagar
                    </p>
                  </div>
                </div>
                <button
                ...
                <div className="p-4 rounded-2xl bg-emerald-500/5 dark:bg-emerald-950/20 border border-emerald-500/30 dark:border-emerald-800/40 space-y-3">
                  ...
                  <div className="pt-2 border-t border-emerald-500/20 flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-slate-400">
                      Gera lançamento com status {form.pago ? "PAGO" : "PENDENTE"}
                    </span>
                  </div>
                </div>
