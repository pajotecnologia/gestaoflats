  ...
  return (
    <div className="min-h-screen md:h-screen md:overflow-hidden flex flex-col md:flex-row bg-slate-100 dark:bg-zinc-950 text-slate-800 dark:text-zinc-100 transition-colors duration-200">
      ...
      <div className="flex-1 flex flex-col min-w-0 md:h-screen md:overflow-hidden">
        ...
        <header className="flex-shrink-0 flex items-center justify-between px-3 sm:px-4 py-2 sm:py-2.5 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-slate-200/80 dark:border-zinc-800/80">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <button
              onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
              className="md:hidden min-h-[44px] min-w-[44px] flex items-center justify-center p-2 rounded-xl text-slate-600 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800/80 transition-colors cursor-pointer"
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2.5">
            ...
            <Link
              href="/ajuda"
              className="min-h-[40px] min-w-[40px] sm:min-h-[38px] sm:min-w-[38px] flex items-center justify-center p-2 rounded-xl bg-slate-100 dark:bg-zinc-900/80 hover:bg-indigo-50 dark:hover:bg-indigo-950/50 text-slate-600 dark:text-zinc-300 hover:text-indigo-600 dark:hover:text-indigo-400 border border-slate-200/60 dark:border-zinc-800/80 hover:border-indigo-200 dark:hover:border-indigo-800/60 transition-all duration-200"
            ...
            <button
              ...
              className="relative min-h-[40px] min-w-[40px] sm:min-h-[38px] sm:min-w-[38px] flex items-center justify-center p-2 rounded-xl bg-slate-100 dark:bg-zinc-900/80 hover:bg-slate-200 dark:hover:bg-zinc-800 text-slate-600 dark:text-zinc-300 border border-slate-200/60 dark:border-zinc-800/80 transition-all duration-200 cursor-pointer"
            ...
            <button
              ...
              className="min-h-[40px] min-w-[40px] sm:min-h-[38px] sm:min-w-[38px] flex items-center justify-center p-2 rounded-xl bg-slate-100 dark:bg-zinc-900/80 hover:bg-slate-200 dark:hover:bg-zinc-800 text-slate-600 dark:text-zinc-300 border border-slate-200/60 dark:border-zinc-800/80 transition-all duration-200 cursor-pointer"
            ...
            <button
              ...
              className="min-h-[40px] sm:min-h-[38px] flex items-center space-x-1.5 px-2.5 sm:px-3 py-2 rounded-xl bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 dark:hover:bg-rose-900/60 border border-rose-200 dark:border-rose-800/40 text-rose-600 dark:text-rose-300 text-xs font-semibold transition-all duration-200 shrink-0 cursor-pointer"
